---
title: "Plugins Code File Export Is Default Export"
source: "https://www.framer.com/developers/reference/plugins-code-file-export-is-default-export"
domain: "framer.com"
scraped_at: "2025-08-26T17:04:44.982Z"
---
# Plugins Code File Export Is Default Export
###### Search
Get Started
...
### [Type](https://www.framer.com/developers/reference/plugins-code-file-export-is-default-export#type)
`boolean`
### [Previous insertURL ](https://www.framer.com/developers/reference/plugins-code-file-export-insert-url)### [Next name ](https://www.framer.com/developers/reference/plugins-code-file-export-name)
Resources
...
---
*Scraped from: https://www.framer.com/developers/reference/plugins-code-file-export-is-default-export*