---
title: "Plugins Code File Export Name"
source: "https://www.framer.com/developers/reference/plugins-code-file-export-name"
domain: "framer.com"
scraped_at: "2025-08-26T17:04:46.193Z"
---
# Plugins Code File Export Name
###### Search
Get Started
...
# name
Export name
### [Type](https://www.framer.com/developers/reference/plugins-code-file-export-name#type)
`string`
### [Previous isDefaultExport ](https://www.framer.com/developers/reference/plugins-code-file-export-is-default-export)### [Next type ](https://www.framer.com/developers/reference/plugins-code-file-export-type)
Resources
...
---
*Scraped from: https://www.framer.com/developers/reference/plugins-code-file-export-name*