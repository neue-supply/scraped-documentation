---
title: "Plugins Code File Export Insert Url"
source: "https://www.framer.com/developers/reference/plugins-code-file-export-insert-url"
domain: "framer.com"
scraped_at: "2025-08-26T17:04:43.696Z"
---
# Plugins Code File Export Insert Url
###### Search
Get Started
...
### [Type](https://www.framer.com/developers/reference/plugins-code-file-export-insert-url#type)
`string` only present for `type: "component"`
### [Previous CodeFileExport ](https://www.framer.com/developers/reference/plugins-code-file-export)### [Next isDefaultExport ](https://www.framer.com/developers/reference/plugins-code-file-export-is-default-export)
Resources
...
---
*Scraped from: https://www.framer.com/developers/reference/plugins-code-file-export-insert-url*