...
Follow these steps to apply a label
  1. To apply a label to an area:
     ...
     * On the area card, select the edit 
  ...
  3. To apply a label to an automation, scene, or script:
     ...
     * Select the 
     * From the list, select all the list entries to which you want to apply a label.
     * In the top right corner, select the three dots **Add label**. Then, select the labels from the list.
...
Follow these steps to delete a label. It will be removed from all the list entries it was applied to. If you used this label in automations or script as targets, you need to adjust those.
  1. Go to [**Settings** > **Areas, labels & zones**](https://my.home-assistant.io/redirect/labels) and on top, select the **Labels** tab.
  2. In the list of labels, find the label you want to delete and select the three dots 
  3. Select **Delete**.
...
## Removing labels 
  ...
  2. Select the 
     ...
     * In the top right corner, select the three dots **Add label**.
