...
### Prerequisites 
  ...
  * The devices you want to control with Assist are [exposed to Assist](https://www.home-assistant.io/voice_control/voice_remote_expose_devices/) and you have checked most of the [best practices](https://www.home-assistant.io/voice_control/best_practices/)
...
### Starting Assist in Home Assistant 
  ...
  3. [Give a command](https://www.home-assistant.io/voice_control/custom_sentences/).
...
To use Home Assistant Assist as your voice assistant, follow these steps:
  ...
  2. Choose one of following options to activate Assist: 
     * [Start Assist using a back tap](https://www.home-assistant.io/voice_control/apple/#to-start-assist-using-a-back-tap).
     * [Start Assist using the action button](https://www.home-assistant.io/voice_control/apple/#to-start-assist-using-the-action-button).
     * [Start Assist using control center](https://www.home-assistant.io/voice_control/apple/#to-start-assist-using-control-center).
     * [Start Assist from Lock Screen](https://www.home-assistant.io/voice_control/apple/#to-start-assist-from-lock-screen).
  3. [Give a command](https://www.home-assistant.io/voice_control/custom_sentences/).
