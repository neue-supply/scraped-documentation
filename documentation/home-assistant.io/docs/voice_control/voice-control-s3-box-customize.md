...
### Prerequisites 
  ...
  * Successfully completed the [ESP32-S3-BOX-3 voice assistant](https://www.home-assistant.io/voice_control/s3_box_voice_assistant/) tutorial
...
Before you can import new illustrations, you need to install the ESPHome add-on and adopt the device in the add-on.
  ...
  6. Now that you have set up the ESPHome add-on, continue with one of the 2 different methods to add custom images:
     * [Option 1: Using images from a community repository](https://www.home-assistant.io/voice_control/s3-box-customize/#option-1-using-images-from-a-community-repository)
     * [Option 2: Using your own images](https://www.home-assistant.io/voice_control/s3-box-customize/#option-2-using-your-own-illustrations)


### Option 1: Using images from a community repository 
If you want new images but don’t want to create your own, you can use images from the community. If you want to use your own images, skip this procedure and go to [Option 2: Using your own images](https://www.home-assistant.io/voice_control/s3-box-customize/#option-2-using-your-own-illustrations) instead.
...
Copy
  ...
  5. Once the installation is complete, you can see the new image on the ESP32-S3-BOX-3.
     * Now, speak a command to test the new setting. For example, _OK Nabu, turn off the living room lights_.


### Option 2: Using your own illustrations 
There are 2 parts to this:
  * [Preparing your own illustrations](https://www.home-assistant.io/voice_control/s3-box-customize/#to-prepare-your-own-images)
  * [Adding your illustrations to the configuration](https://www.home-assistant.io/voice_control/s3-box-customize/#to-add-your-images-to-the-configuration)
...
In the [overview diagram](https://www.home-assistant.io/voice_control/s3-box-customize/#esp32-s3-box-3-voice-assistant-status-illustrations), you can see that the default images use different background colors. This is to make it easier to recognize a state change when you look at your screen.
...
#### To prepare your own images 
  1. Create your own images according to the specifications defined in the section [About the image specifications](https://www.home-assistant.io/voice_control/s3-box-customize/#about-the-image-specifications). 
     * You could even draw your own!
     * There’s a [template](https://www.home-assistant.io/voice_control/s3-box-customize/#to-draw-your-own-images) for it.
  2. Copy all 6 images into a folder. For example: `voice_assistant_gfx`.
  3. Make sure you have [access to your configuration files](https://www.home-assistant.io/common-tasks/os/#configuring-access-to-files). 
     * [Install the Samba add-on](https://www.home-assistant.io/common-tasks/os/#installing-and-using-the-samba-add-on).
...
Copy
  ...
  7. Once the installation is complete, you can see the new image on the S3-BOX.
     * Now, speak a command to test the new setting. For example, _OK Nabu, turn on the light_.
...
## To draw your own images 
  ...
  3. When you are done:
     ...
     * [Follow these steps](https://www.home-assistant.io/voice_control/s3-box-customize/#to-prepare-your-own-images) to bring them onto your Voice Assistant.
...
### Prerequisites 
  * Home Assistant 2024.2, installed with the Home Assistant Operating System. If you do not have Home Assistant installed yet, refer to the [installation page](https://www.home-assistant.io/installation/) for instructions.
  * Successfully [installed ESPHome on the S3-BOX-3](https://www.home-assistant.io/voice_control/s3_box_voice_assistant/)
  ...
  * [On-device wake word installed](https://www.home-assistant.io/voice_control/s3-box-customize/#installing-on-device-wake-words-microwakeword) on your S3-BOX-3.


_(It also works on the (now discontinued) S3-BOX and S3-BOX-Lite)_
### To customize the S3-BOX-3 with on-device wake words 
  1. If you haven’t done so already, [adopt the device in the ESPHome add-on](https://www.home-assistant.io/voice_control/s3-box-customize/#adopting-the-device-in-the-esphome-add-on).
...
Copy
  ...
  7. Now, speak a command to test the new setting. For example, _Hey Jarvis, turn on the light_.


## Related topics 
  * [ Home assistant cloud ](https://www.home-assistant.io/voice_control/voice_remote_cloud_assistant/)
  * [ Esp32 s3 box 3 voice assistant ](https://www.home-assistant.io/voice_control/s3_box_voice_assistant/)
  * [ General troubleshooting section for assist ](https://www.home-assistant.io/voice_control/troubleshooting/)
  * [ Troubleshooting the esp32 s3 box 3 ](https://www.home-assistant.io/voice_control/troubleshooting_the_s3_box/)
