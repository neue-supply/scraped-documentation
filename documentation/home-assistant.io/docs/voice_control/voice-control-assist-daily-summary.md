...
This tutorial assumes you have a few things set up already:
  * [Home Assistant Cloud](https://www.nabucasa.com) or a manually configured [local assistant pipeline](https://www.home-assistant.io/voice_control/voice_remote_local_assistant/).
...
Skip this if you’re already using a calendar.
  1. Go to the [integrations page](https://www.home-assistant.io/integrations/) and select the calendar **Calendar** filter.
  2. Pick a calendar you like and install it as described in the documentation.
  3. If you just want to follow along with this tutorial, install the [local calendar](https://www.home-assistant.io/integrations/local_calendar/) integration. 
...
Skip this if you’re already using a weather integration.
  1. Go to the [integrations page](https://www.home-assistant.io/integrations/) and select the **Weather** filter.
  2. Pick a calendar you like and install it as described in the documentation.
...
Skip this if you’re already using a notification integration.
  1. Go to the [integrations page](https://www.home-assistant.io/integrations/) and select the **Notifications** filter.
  ...
  5. To get started with Telegram on Home Assistant, follow the [set up instruction](https://www.home-assistant.io/integrations/telegram/#setup-example) step by step. 
...
The OpenAI personality gives the messages a special touch. Using OpenAI requires an OpenAI account. For this tutorial, the free trial option is sufficient. No need to leave your credit card information.
  * [Create a Mario personality](https://www.home-assistant.io/voice_control/assist_create_open_ai_personality/).


### Creating an automation from a blueprint 
We are using a blueprint (courtesy of [@allenporter](https://github.com/allenporter)) that polls calendar events and collects weather information. It then asks ChatGPT to summarize it and ships that response to your phone.
  ...
  5. To view the automation, go to [**Settings** > **Automations & Scenes**](https://my.home-assistant.io/redirect/automations).
...
## Related topics 
  ...
  * [ Telegram notification ](https://www.home-assistant.io/integrations/telegram/#setup-example)
  * [ Telegram notification ](https://www.home-assistant.io/voice_control/assist_create_open_ai_personality/)
