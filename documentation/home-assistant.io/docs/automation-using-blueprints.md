...
Copy
  ...
  3. Select the blue button in the bottom right.
...
### To re-import a blueprint 
  1. Go to **[Settings> Automations & Scenes > Blueprints](https://my.home-assistant.io/redirect/blueprints)**.
  2. On the blueprint that you want to re-import, select the three dots **Re-import blueprint**.
