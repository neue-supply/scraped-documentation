...
### Home Assistant 
The Home Assistant trigger is recommended for automations instead of [homeassistant_start or homeassistant_stop events](https://www.home-assistant.io/docs/configuration/events/#homeassistant_start-homeassistant_started).
...
`trigger.details` | Object with matched slot details by name, such as [wildcards](https://www.home-assistant.io/docs/automation/trigger/#sentence-wildcards). Each detail contains: 
